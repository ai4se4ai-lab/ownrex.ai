...
ssuite({ title: 'settingsEditorSearchResultsSelector', location: 'external' }, () => {
	...
	stest({ description: 'Selects expected agent mode setting' }, async (testingServiceCollection) => {
		...
		const settingsList: SettingListItem[] = [
			{
				'key': 'ownrex.ai.chat.codesearch.enabled',
				'type': 'boolean',
			...
			{
				'key': 'ownrex.ai.chat.agent.runTasks',
				'type': 'boolean',
			...
			{
				'key': 'ownrex.ai.advanced',
				'type': 'object'
			},
			{
				'key': 'ownrex.ai.chat.newWorkspaceCreation.enabled',
				'type': 'boolean',
			...
			{
				'key': 'ownrex.ai.chat.completionContext.typescript.mode',
				'type': 'string',
			...
			{
				'key': 'ownrex.ai.chat.agent.thinkingTool',
				'type': 'boolean',
