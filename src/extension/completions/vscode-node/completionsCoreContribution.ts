...
export class CompletionsCoreContribution extends Disposable {
	...
	constructor(
		...
		this._register(autorun(reader => {
			...
			void commands.executeCommand('setContext', 'ownrex.ai.extensionUnification.activated', extensionUnification);
		...
		this._register(autorun(reader => {
			...
			void commands.executeCommand('setContext', 'ownrex.ai.activated', token !== undefined);
		}));
	}
}
