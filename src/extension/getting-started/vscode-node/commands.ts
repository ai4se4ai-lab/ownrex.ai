...
export class WalkthroughCommandContribution extends Disposable {
	constructor() {
		super();
		this._register(vscode.commands.registerCommand('ownrex.ai.open.walkthrough', () => {
			vscode.commands.executeCommand('workbench.action.openWalkthrough', { category: 'ownrex.ai-chat#copilotWelcome' }, /* toSide */ false);
		}));

		this._register(vscode.commands.registerCommand('ownrex.ai.mcp.viewContext7', () => {
