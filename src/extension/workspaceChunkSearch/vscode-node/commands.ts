...
export const buildLocalIndexCommandId = 'ownrex.ai.buildLocalWorkspaceIndex';
export const buildRemoteIndexCommandId = 'ownrex.ai.buildRemoteWorkspaceIndex';
...
export function register(accessor: ServicesAccessor): IDisposable {
	...
	disposableStore.add(vscode.commands.registerCommand('ownrex.ai.debug.collectWorkspaceIndexDiagnostics', async () => {
